...
export class AudioControlPauseButton extends LitElement {

}

customElements.define('audio-control-pause-button', AudioControlPauseButton)
...
// note: the CSS is a reset button element, I'm saving this here in case I need it for later.
...
//   button:hover,
//   button:focus {
//     /* filter: invert(100%); /* todo: temp */ */
//       /* -webkit-filter: invert(100%); */
//     background: #0053ba; /* todo: temp */
//   }
//
//   button:focus {
//     outline: 1px solid #fff;
